...
1. Is it *consistently* wrong? (Precision is fine, accuracy is off)
2. Is it *inconsistently* wrong? (Accuracy might be fine, precision is off)
3. Is it *randomly* wrong? (Both are off, or you're measuring wrong)
